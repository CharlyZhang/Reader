...
{
    Selection *sel = [[[self class] allocWithZone:zone] initWithStartState:initialState];
    sel.transform = self.transform;
    sel.frame = self.frame;
    sel.pageNo = pageNo;
    sel.lineContent = lineContent;
    sel.sectionTitle = sectionTitle;
    return sel;
}
