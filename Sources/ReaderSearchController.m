...
{
    if ((UI_USER_INTERFACE_IDIOM() != UIUserInterfaceIdiomPad)) [self printDebugFrameWhen:@"willRotation before adjust"];
    [self adjustSearchViewWidth];
    if ((UI_USER_INTERFACE_IDIOM() != UIUserInterfaceIdiomPad)) [self printDebugFrameWhen:@"willRotation after adjust"];
}
